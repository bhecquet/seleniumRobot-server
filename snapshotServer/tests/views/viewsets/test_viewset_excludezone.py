...
class TestViewsetExcludeZone(TestApi):
    ...
    def _create_excludezone(self, expected_status):
        response = self.client.post('/snapshot/api/exclude/',
                                    data={'snapshot': 1, 'x': 0, 'y': 0, 'width': 10, 'height': 10})
    ...
    def test_excludezone_create(self):
        ...
        self._create_and_authenticate_user_with_permissions(
            Permission.objects.filter(Q(codename='add_excludezone', content_type=self.content_type_excludezone)))
    ...
    def test_excludezone_other_verbs_forbidden(self):
        ...
        """
        self._create_and_authenticate_user_with_permissions(
            Permission.objects.filter(Q(codename='view_excludezone', content_type=self.content_type_excludezone)
    ...
    def test_excludezone_create_with_application_restriction_and_app2_permission(self):
        """
        User
        - has NOT add_excludezone permission
        - has app2 permission

        User can NOT add test info on an other application than app2
        """
    ...
    def test_excludezone_create_with_application_restriction_and_env_DEV_permission(self):
        """
        User
        - has NOT add_excludezone permission
    ...
    def test_excludezone_create_with_application_restriction_and_env_PROD_permission(self):
        """
        User
        - has NOT add_excludezone permission
    ...
    def test_excludezone_update_with_model_permission(self):
        ...
        """
        self._create_and_authenticate_user_with_permissions(
            Permission.objects.filter(Q(codename='change_excludezone', content_type=self.content_type_excludezone)))
    ...
    def test_excludezone_delete_with_model_permission(self):
        ...
        """
        self._create_and_authenticate_user_with_permissions(
            Permission.objects.filter(Q(codename='delete_excludezone', content_type=self.content_type_excludezone)))
