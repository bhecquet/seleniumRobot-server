...
class TestTestResultView(SnapshotTestCase):
    ...
    def test_report_result_ok(self):
        ...
        self.assertEqual(response.context['logs'],
                         [' INFO  2023-10-25 14:53:50,941 [TestNG-test=jenkins-1] SeleniumRobotTestListener: Start method loginInvalid\r',
        ...
        ## details table
        self.assertTrue(
            """<table class="table table-bordered table-sm"><tr><th style="width: 20%">Application type</th><td>Browser</td></tr><tr><th>Application</th><td>Firefox</td></tr><tr><th>Grid node</th><td>None</td></tr>""" in html)
        ## links to last state
        ...
        ## steps / sub-steps
        self.assertTrue(
            '<div class="box success"><!-- Step result 1 --><div class="box-header with-border"><button type="button" class="btn btn-box-tool collapsed" data-bs-toggle="collapse" data-bs-target="#box-body-1" aria-expanded="false" aria-controls="box-body-1">'
        ...
        self.assertTrue(
            """<div class="message-conf"><span class="stepTimestamp mr-1">14:53:58.815</span>Opening page LoginPage""" in html)
        self.assertTrue(
            """<div class="message-conf"><span class="stepTimestamp mr-1">14:53:58.816</span>setWindowToRequestedSize on on page LoginPage""" in html)
        self.assertTrue(
            """<div class="message-conf"><span class="stepTimestamp mr-1">14:53:58.816</span>maximizeWindow on on page LoginPage""" in html)
        self.assertTrue(
            """<div class="box success"><!-- Step result 2 --><div class="box-header with-border"><button type="button" class="btn btn-box-tool collapsed" data-bs-toggle="collapse" data-bs-target="#box-body-2" aria-expanded="false" aria-controls="box-body-2"><i class="fa-solid fa-angle-right collapse-icon"></i></button><span class="step-title">loginInvalid with args: (foo, bar, )  - 2.0 secs</span><span><i class="fas fa-file-video"></i>1.171 s</span>""" in html)
        ### sub-step inside step
        self.assertTrue(
            """<ul><li><div class="message-conf"><span class="stepTimestamp mr-1">14:54:01.41</span>click on ButtonElement check, by={By.name: check}""" in html)
        self.assertTrue(
            '<div class="box success"><!-- Step result 3 --><div class="box-header with-border"><button type="button" class="btn btn-box-tool collapsed" data-bs-toggle="collapse" data-bs-target="#box-body-3" aria-expanded="false" aria-controls="box-body-3">'
        ...
        self.assertTrue(
            """<div class="box success"><!-- Step result 4 --><div class="box-header with-border"><button type="button" class="btn btn-box-tool collapsed" data-bs-toggle="collapse" data-bs-target="#box-body-4" aria-expanded="false" aria-controls="box-body-4"><i class="fa-solid fa-angle-right collapse-icon"></i></button><span class="step-title">Test end  - 0.2 secs</span><span><i class="fas fa-file-video"></i>9.2 s</span>""" in html)
        ## pictures on steps
        self.assertTrue(
            '''<a href="#" onclick="$('#imagepreview').attr('src', $('#88').attr('src'));$('#imagemodal').modal('show');"><img id="88" src="/snapshot/api/file/88/download/" style="width: 300px"></a></div></div><div class="text-center">drv:main:Current Window: S&#x27;identifier [Jenkins]</div>'''
            '<div class="text-center font-weight-lighter"><a href="https://jenkins/login?from=%2Fjenkins%2F" target=url>URL</a>' in html)
        ## log value on step
        self.assertTrue(
            '<table class="table table-bordered table-sm"><tr><th style="width:15%">Key</th><th style="width:60%">Message</th><th style="width:25%">Value</th></tr>'
    ...
    def test_report_result_ko(self):
        ...
        self.assertTrue(
            '<div class="box failed"><!-- Step result 13 --><div class="box-header with-border"><button type="button" class="btn btn-box-tool collapsed" data-bs-toggle="collapse" data-bs-target="#box-body-13" aria-expanded="false" aria-controls="box-body-13">'
        ...
        self.assertTrue(
            '<div class="box failed"><!-- Step result 14 --><div class="box-header with-border"><button type="button" class="btn btn-box-tool collapsed" data-bs-toggle="collapse" data-bs-target="#box-body-14" aria-expanded="false" aria-controls="box-body-14">'
        ...
        ## in header
        self.assertTrue(
            '<tr><th>Last State</th><td><a class="errorTooltip" tabindex="0" data-bs-trigger="focus" data-bs-toggle="popover" title="Exception" data-bs-content="Browsermob proxy (captureNetwork option) is only compatible with DIRECT and &lt;MANUAL&gt;"><i class="fas fa-file-alt" aria-hidden="true"></i></a></td></tr>' in html)
        ## on last step
        self.assertTrue(
            '<div class="message-log message-conf"><span class="stepTimestamp mr-1"></span>Test is KO with error: class java.lang.AssertionError: expected [false] but &lt;&gt; found [true]' in html)
        ...
        # reference snapshot
        self.assertTrue(
            '''<div class="message-snapshot col"><div class="message-snapshot col"><div class="text-center"><a href="#" onclick="$('#imagepreview').attr('src', $('#108').attr('src'));$('#imagemodal').modal('show');">'''
        ...
        self.assertTrue(
            '''<div class="message-snapshot col"><div class="message-snapshot col"><div class="text-center"><a href="#" onclick="$('#imagepreview').attr('src', $('#109').attr('src'));$('#imagemodal').modal('show');">'''
    ...
    def test_report_result_encoding(self):
        ...
        # step is encoded
        self.assertTrue("""<span class="step-title">❌getErrorMessage&lt;&gt;""" in html)

        # error message is encoded
        self.assertTrue(
            """<div class="message-error">class java.lang.AssertionError: expected [false] but &lt;_&gt; found [true]</div>""" in html)

        # actions are encoded
        self.assertTrue(
            """<span class="stepTimestamp mr-1"></span>Test is KO with error: class java.lang.AssertionError: expected [false] but &lt;&gt; found [true]""" in html)

        # logs are encoded
        self.assertTrue(
            """<div>INFO  2023-10-25 14:53:50,941 [TestNG-test=jenkins-1] SeleniumRobotTestListener: Start method loginInvalid &lt;;&gt;""" in html)

        # last state is encoded
        self.assertTrue(
            """data-bs-toggle="popover" title="Exception" data-bs-content="Browsermob proxy (captureNetwork option) is only compatible with DIRECT and &lt;MANUAL&gt;""" in html)
    ...
    def test_report_with_snapshot_comparison_ok_display_only(self):
        ...
        self.assertTrue(
            '<div class="box success"><div class="box-header with-border"><button type="button" class="btn btn-box-tool collapsed" data-bs-toggle="collapse" data-bs-target="#box-body-snapshot-comparison" aria-expanded="false" aria-controls="box-body-snapshot-comparison"><i class="fa-solid fa-angle-right collapse-icon"></i></button>Snapshot comparison' in html)
        self.assertTrue(
            '<i class="fas fa-file-video"></i>1.171 s<i class="fa-solid fa-code-compare font-success"></i>' in html)  # check icon is present when comparison is done in step
    ...
    def test_report_with_snapshot_comparison_ko_display_only(self):
        ...
        self.assertTrue(
            '<i class="fas fa-file-video"></i>1.171 s<i class="fa-solid fa-code-compare font-failed"></i>' in html)  # check icon is present when comparison is done in step
        self.assertEqual(html.count('fa-solid fa-code-compare'), 1, "Only one icon of image comparison should be present")
    ...
    def test_report_with_snapshot_comparison_ko_change_test_result(self):
        ...
        html = self.remove_spaces(response.rendered_content)
        self.assertTrue(
            '<div class="box failed"><div class="box-header with-border"><button type="button" class="btn btn-box-tool collapsed" data-bs-toggle="collapse" data-bs-target="#box-body-snapshot-comparison" aria-expanded="false" aria-controls="box-body-snapshot-comparison"><i class="fa-solid fa-angle-right collapse-icon"></i></button>Snapshot comparison' in html)
        self.assertTrue('Snapshot comparison KO' in html)
    ...
    def test_report_with_step_in_warning(self):
        ...
        print(html)
        self.assertTrue(
            """<div class="box warning"><!-- Step result 15 --><div class="box-header with-border"><button type="button" class="btn btn-box-tool collapsed" data-bs-toggle="collapse" data-bs-target="#box-body-15" aria-expanded="false" aria-controls="box-body-15"><i class="fa-solid fa-angle-right collapse-icon"></i></button><span class="step-title">getErrorMessage warn  - 5.0 secs</span><span><i class="fas fa-file-video"></i>4.35 s</span>""" in html)
    ...
    def test_report_with_started_by(self):
        ...
        self.assertTrue(
            """<tr><th>Started by</th><td><a href=http://myTestLauncher/foo/bar?test=test1&amp;param=1>http://myTestLauncher/foo/bar?test=test1&amp;param=1</a></td></tr>""" in html)
    ...
    def test_report_message_style(self):
        ...
        self.assertTrue(
            """<div class="message-error message-conf"><span class="stepTimestamp mr-1"></span>!!!FAILURE ALERT!!! - Assertion Failure: expected [false] but found [true]""" in html)
        self.assertTrue(
            """<div class="message-warning message-conf"><span class="stepTimestamp mr-1"></span>[NOT RETRYING] max retry count (0) reached""" in html)
        self.assertTrue(
            """<div class="message-info message-conf"><span class="stepTimestamp mr-1"></span>Video file copied to videoCapture.avi""" in html)
