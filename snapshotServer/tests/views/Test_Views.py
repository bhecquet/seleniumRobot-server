...
class TestViews(django.test.TestCase):
    ...
    def setUp(self):
        ...
        self.tcs1.save()
        self.session2 = TestSession(sessionId="1238", date=datetime.datetime(2017, 5, 7, tzinfo=pytz.UTC), browser="firefox", version=Version.objects.get(pk=1), environment=TestEnvironment.objects.get(id=1), ttl=datetime.timedelta(0))
        self.session2.save()
