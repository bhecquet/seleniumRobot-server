...
class TestTestStatusView(TestViews):
    ...
    def test_session_status_security_not_authenticated(self):
        ...
        """
        response = Client().get(reverse('testStatusView', kwargs={'testCaseId': 5}))
    ...
    def test_session_status_security_authenticated_no_permission_on_application(self):
        ...
        user, client = self._create_and_authenticate_user_with_permissions(Permission.objects.filter(Q(codename='can_view_application_myapp2', content_type=self.content_type_application)))
        response = client.get(reverse('testStatusView', kwargs={'testCaseId': 5}))
    ...
    def test_session_status_security_authenticated_with_permission_on_application(self):
        ...
        user, client = self._create_and_authenticate_user_with_permissions(Permission.objects.filter(Q(codename='can_view_application_myapp', content_type=self.content_type_application)))
        response = client.get(reverse('testStatusView', kwargs={'testCaseId': 5}))
    ...
    def test_session_status_security_authenticated_with_permission_on_environment(self):
        ...
        user, client = self._create_and_authenticate_user_with_permissions(Permission.objects.filter(Q(codename='can_view_environment_DEV', content_type=self.content_type_environment)))
        response = client.get(reverse('testStatusView', kwargs={'testCaseId': 5}))
    ...
    def test_session_status_security_authenticated_with_permission_on_other_environment(self):
        ...
        user, client = self._create_and_authenticate_user_with_permissions(Permission.objects.filter(Q(codename='can_view_environment_PROD', content_type=self.content_type_environment)))
        response = client.get(reverse('testStatusView', kwargs={'testCaseId': 5}))
    ...
    def test_session_status_security_authenticated_with_permission_object_not_found(self):
        ...
        user, client = self._create_and_authenticate_user_with_permissions(Permission.objects.filter(Q(codename='can_view_application_myapp', content_type=self.content_type_application)))
        response = client.get(reverse('testStatusView', kwargs={'testCaseId': 568}))
    ...
    def test_session_status_ok_on_non_reference(self):
        ...
        response = client.get(reverse('testStatusView', kwargs={'testCaseId': 6}))
        self.assertEqual(response.status_code, 200)
        data = json.loads(response.content.decode('UTF-8'))
    ...
    def test_step_status(self):
        ...
        response = client.get(reverse('testStepStatusView', kwargs={'testCaseId': 5, 'testStepId': 2}))
        self.assertEqual(response.status_code, 200)
        data = json.loads(response.content.decode('UTF-8'))
        self.assertTrue(data['5'])