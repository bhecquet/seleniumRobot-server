...
class TestTestSessionSummaryView(SnapshotTestCase):
    ...
    def test_summary_report_result_ko_with_recorded_error_with_related(self):
        ...
        with self.settings(RESTRICT_ACCESS_TO_APPLICATION_IN_ADMIN=True):
            ...
            self.assertTrue("""<div class="offcanvas-body"><table class="table"><th scope="col">Session</th><th scope="col">Test name</th><th scope="col">Test date</th><tr><td>May 5, 2023, 3:16 p.m.</td><td><a href='/snapshot/testResults/result/11/'>testJenkinsKo</a></td><td>May 5, 2023, 3:16 p.m.</td></tr></table></div></div></td><""" in html)
    ...
    def test_summary_report_result_ko_with_recorded_error_with_related_and_same_error(self):
        ...
        with self.settings(RESTRICT_ACCESS_TO_APPLICATION_IN_ADMIN=True):
            ...
            self.assertTrue("""<div class="offcanvas-body"><table class="table"><th scope="col">Session</th><th scope="col">Test name</th><th scope="col">Test date</th><tr><td>May 5, 2023, 3:16 p.m.</td><td><a href='/snapshot/testResults/result/110/'>testJenkinsKo2</a></td><td>May 5, 2023, 3:20 p.m.</td></tr></table></div></div></td><""" in html)
